...
export const Header = () => {
    ...
    {/*{loggedIn ? <Link to="/reject"><button type="button"  > Odwołanie rezerwacji </button>  </Link> :null }*/}
          {loggedIn ?  null: <Link to="/book"> <button type="button" > Zarezerwuj termin </button> </Link>  }
          {loggedIn ?  null: <Link to="/reject"><button type="button"  > Odwołanie rezerwacji </button>  </Link>  }
